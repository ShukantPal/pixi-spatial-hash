 ...
 *
 * renderer.addSystem("spatialHash", SpatialHashSystem);
 ...
 * @public
 */
class SpatialHashSystem extends core.System {
    ...
    search(objectOrBounds) {
        ...
        if (objectOrBounds instanceof display.DisplayObject || objectOrBounds.getBounds) {
...
exports.SpatialHashSystem = SpatialHashSystem;
